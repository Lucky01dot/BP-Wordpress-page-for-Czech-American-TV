<?php
	...
	class GT_Plugin_Public {
        ...
        public GT_Plugin_EN_CZ_Translation  $plugin_en_cz_translation;
		...
		public function __construct( GT_Plugin $plugin ) {
            ...
            $this->plugin_en_cz_translation  = new GT_Plugin_EN_CZ_Translation( $this );
		...
		public function register() {
            ...
            $this->plugin_en_cz_translation->register();
		}
		...
		public function enqueue_scripts() {
            ...
            $translation        = $this->plugin->shortcode_check( $this->plugin_en_cz_translation->shortcodes );
