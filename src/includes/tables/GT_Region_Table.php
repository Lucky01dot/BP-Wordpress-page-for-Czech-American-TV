...
/**
 * Class for regions table.
 */
class GT_Region_Table extends GT_Table {
	...
	/**
	 * @var string Name of the map code field.
	 */
	public string $map_code = "map_code";
	...
	public function create( wpdb $wpdb ): bool {
        ...
        CREATE TABLE IF NOT EXISTS `{$this->_tablename_}` (
			...
			`{$this->map_code}` varchar(8) NOT NULL,
