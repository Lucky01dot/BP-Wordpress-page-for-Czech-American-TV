...
jQuery(document).ready(function ($) {
    ...
    /**
     * CZ_EN translation (cz_en translations) form import for one record
     */

    $(GT_SELECTOR.CZ_EN_TRANSLATION_IMPORT_ONE_FORM).on("submit", function (event) {
        insert_one_record("cz_en_translations", GT_SELECTOR.CZ_EN_TRANSLATION_IMPORT_ONE_WORD, null, null, GT_SELECTOR.FN_TRANSLATION_IMPORT_ONE_NAME_EN, GT_SELECTOR.FN_TRANSLATION_IMPORT_ONE_PRIORITY, GT_SELECTOR.FN_TRANSLATION_IMPORT_INFO);
    });
    ...
    function insert_one_record(table, selector_name, selector_explanation, selector_diminutive, selector_name_en, selector_priority, selector_czech_word, selector_english_translation,status_selector) {
        ...
        $.post(__ajax_obj.url, {
            ...
            if (data.hasOwnProperty("status")) {
                ...
                if (data.status === "success") {
                    ...
                    $(selector_english_translation).val("");
                    $(selector_czech_word).val("");
