...
class GT_Container {
    ...
    private const FN_EN_CZ_TRANSLATION_DAO = 'fn_en_cz_translation_dao';
    ...
    public function get_cz_en_transtation_dao(): GT_FN_EN_CZ_translation_DAO {
        if( ! isset( $this->objects[ self:: FN_EN_CZ_TRANSLATION_DAO ] ) ) {

            $database = $this->get_database();
        }
        $this->objects[self::FN_EN_CZ_TRANSLATION_DAO] = new GT_FN_EN_CZ_translation_DAO( $database );


        return $this->objects[ self::FN_EN_CZ_TRANSLATION_DAO ];
    }
