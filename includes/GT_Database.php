...
class GT_Database {
    ...
    public GT_FN_EN_CZ_Translation_Table $fn_en_cz_translation_table;
	...
	public function __construct( string $host, string $database, string $username, string $password, string $table_prefix = "gt_" ) {
        ...
        $this->fn_en_cz_translation_table = new GT_FN_EN_CZ_Translation_Table($table_prefix . GT_Tables::EN_CZ_TRANSLATION);
	...
	protected function sorted_tables(): array {
		return [
            ...
            $this->fn_en_cz_translation_table,
